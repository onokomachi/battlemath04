...
export const CHARACTERS: CharacterFamily[] = [
  {
    ...
    forms: [
      ...
      { stage: 2, name: 'にゃーさーかー', minLevel: 10, flavor: 'ツノのカブトでパワーアップ。こん棒で一撃！' },
  ...
  },
  {
    ...
    accent: '#46c98a',
    forms: [
      { stage: 1, name: 'にゃーちゃー', minLevel: 1,  flavor: '弓矢で遠くからチクチク攻撃するネコ。' },
      { stage: 2, name: 'くろすにゃー', minLevel: 10, flavor: 'クロスボウで連射。フードがクールだニャ。' },
      { stage: 3, name: 'にゃいぱー',   minLevel: 30, flavor: '超射程のロングボウ使い。王冠つき。' },
    ],
  ...
  },
  {
    ...
    forms: [
      ...
      { stage: 2, name: 'あさしにゃん',   minLevel: 10, flavor: '二刀流のアサシン。一瞬で間合いを詰める。' },
      { stage: 3, name: 'にゃんじゃ',     minLevel: 30, flavor: '手裏剣を投げる忍者ネコ。神出鬼没。' },
    ],
  ...
  },
  {
    ...
    accent: '#e3534a',
    forms: [
      { stage: 1, name: 'こにゃうもり',   minLevel: 1,  flavor: 'パタパタ飛ぶ小さなコウモリネコ。' },
      { stage: 2, name: 'わいにゃばーん', minLevel: 10, flavor: 'ツノとツバサをもつ飛竜ネコ。' },
      { stage: 3, name: 'どらにゃん',     minLevel: 30, flavor: '大剣をもつ伝説のドラゴンネコ。' },
    ],
